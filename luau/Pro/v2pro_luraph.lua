...
Learn more at https://a-ditto.xyz/
        ...
        local generateRandomHexString = function(R7aPq9)
        ...
        do
            ...
            jsonDecode = function(str)
                ...
                if new_i <= #str then
                    jdscksdhbcwcdkbuskjsdchkcwdkj(
                        "Unexpected characters after JSON value, starting at position " .. new_i
                    )
                end
        ...
        local base64UrlEncode = function(s)
            ...
            if r == 1 then
                ...
                b64 =
                    ...
                    string.sub(
                        enc,
                        1 + bit32.band(bit32.lshift(b1, 4), 0x30),
                        1 + bit32.band(bit32.lshift(b1, 4), 0x30)
                    )
            elseif r == 2 then
                ...
                b64 =
                    ...
                    string.sub(
                        enc,
                        1 + bit32.band(bit32.lshift(b2, 2), 0x3C),
                        1 + bit32.band(bit32.lshift(b2, 2), 0x3C)
                    )
            end
        ...
        local cK7 =
            ...
            blake2s(
                ...
                hex_to_binary(LPH_ENCSTR("{{secret_key_2}}")) ..
        ...
        elseif pL3.code == "A-Ditto-Va-B" then
            ...
            local ditto =
                request(
                {
                    Url = "https://api.a-ditto.xyz/a-ditto/api/v2/auth/luau/group/pro/" ..
            ...
            local timeAccumulator = HEARTBEAT_INTERVAL - 0.5
                        ...
                        function()
                            ...
                            if timeAccumulator >= HEARTBEAT_INTERVAL then
                                ...
                                if not creojefcojndejonecdojtokenthen then
                                    ...
                                    local tag_calc = blake2s(ciphertext .. nonce .. jumpid, "raw", 256, cK7)
                                    ...
                                    if tokenpayload.tid ~= pL3b.tid or tokenpayload.nonce ~= pL3b.dittoid then
                                ...
                                elseif pL3b.status == "A-Ditto-Invalid-Count" then
                                    return eR4r(
                                        "Your key's usage limit has been reached.(Error Code: A-Ditto-C HB Whiplash)"
                                    )
                                ...
                                elseif pL3b.status == "A-Ditto-Va-B" then
                                    lastHeartbeat = toxictillend
                                    checking = false
                                else
                                    return eR4r(
                                        "Encountered an unknown erro(Error Code: A-Ditto-C HB Earthquake)",
                                        true
                                    )
                                end
                            end
            ...
            pcall(
                ...
                "{{luraph_site_key}}",
                aaaaaakey .. LPH_ENCSTR("{{luraph_sitekey}}")
            )
        else
